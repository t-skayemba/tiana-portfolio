        ...
        <main className={styles.page}>
            ...
            <div className={styles.statsRow}>
                {[
                    ...
                    { num: '⌖', desc: 'Full observability via Langfuse — every query logged with latency, tokens, and sources' },
                ].map(s => (
                ...
                <aside className={styles.sidebar}>
                    <div className={styles.sidebarBlock}>
                        ...
                        {[
                            ...
                            'React', 'Vite', 'Tailwind CSS v4', 'Langfuse', 'Railway'
                        ].map(t => (
            ...
            <div className={styles.learnings}>
                ...
                <div className={styles.learningGrid}>
                    {[
                        ...
                        {
                            num: '03',
                            text: 'Observability is not optional in enterprise AI. Adding Langfuse logging transformed the system from a black box into an auditable pipeline — every query, every retrieved chunk, every token. That is what makes clients trust it.',
                        },
                    ].map(l => (
